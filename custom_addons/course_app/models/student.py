...
class Student(models.Model) :
    ...
    name = fields.Char('Name', compute='computer_name') # was previously store=True
    ...
    classlist_student_id = fields.Many2one('list.module', string='Classlist')

    # @api.multi
    # def class_list(self):
    #     for rec in self:
    #         rec.stud = self.search([('program_student_id.module_program_id.name', 'like', 'Business Management')])
    #         print rec.stud
